export const feedbackEventType = "bifrost.discord.persona_conversation_event";
export const feedbackEventSchema = "bifrost.discord.persona_conversation_event.v0";
...
export const feedbackPendingFailureType = "bifrost.persona_feedback.pending_failure";
export const feedbackPendingFailureSchema = "bifrost.persona_feedback.pending_failure.v0";
...
export function buildFeedbackDefinitions(defineDocumentType) {
  ...
  return {
    ...
    pendingFailure: make(feedbackPendingFailureType, feedbackPendingFailureSchema, "failureId", parsePendingFailure),
  };
}
...
export function parseEvent(value) {
  ...
  exact(v.producerId, "bifrost-discord", "producer"); exact(v.authorityClass, "feedback_only", "authorityClass");
